...
import {RESPONSE_TYPES, STATE_INTERNAL} from './constants.js'
 ...
 * Mutates `params`
 *
 * @param {import('./types.d.ts').RetryFnParams} params
 ...
 * @param {import('./types.d.ts').FetchOptions} [options] - The options for the
 *   fetch request.
 * @param {FetchState} [state] - The state object to manage fetch attempts and
 *   other internal states.
 * @returns {Promise<import('./types.d.ts').FetchResponse>} - A promise that
 *   resolves to the fetch response.
 * @throws {Error} - Throws an error if the fetch request fails and should not
 *   be retried.
 */
export const fetch = async (resource, options, state) => {
	...
	do {
		...
		let /** @type {import('./types.d.ts').FetchResponse | undefined} */ response
		try {
			...
			response = /** @type {import('./types.d.ts').FetchResponse} */ (
...
export {HttpError, TimeoutError, Headers, Request, Response}
